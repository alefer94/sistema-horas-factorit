 ...
 * Cliente: FactorIT
 * Archivo fuente: ajax/updateProyectoFreelance.php
...
if ($ajaxUsrID === -1){ 
	...
	if (isset($_POST["prjID"]) && is_numeric($_POST["prjID"])){
		...
		$prjFreelance = !empty($_POST["prjFreelance"])?$_POST["prjFreelance"] : null;
		...
		try { 
			...
			if ($filas_afectadas > 0){
				$callback_response = "Freelance del proyecto fue actualizado.<br/>";
			}
			else {
