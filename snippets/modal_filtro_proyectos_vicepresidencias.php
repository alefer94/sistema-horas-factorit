 ...
 * Cliente: FactorIT
 * Archivo fuente: snippets/modal_filtro_proyectos_vicepresidencias.php
 * Autor: Cristian Lobos
 */
require_once __DIR__.'/../common/InterfazPDO.php';
require_once __DIR__.'/options_vicepresidencias.php';

function modal_filtro_proyectos_vicepresidencias(){ ?>
	<form onsubmit="system.projects.alConfirmarFiltro(event)" for="btn-filtrar_vicepresidencias">
